  ...
  return (
    <div className="bg-white w-full min-h-screen">
      <header className="flex items-center justify-between px-6 lg:px-20 py-6 bg-transparent absolute top-0 left-0 right-0 z-20">
        ...
        <button
          className="md:hidden text-white text-3xl z-30"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl lg:text-2xl text-blue-100 leading-relaxed">
                Access 900+ services without revealing your personal phone
                number. Get SMS and OTP messages from any service.
              </p>
              <button
                onClick={() => navigate("/register")}
        ...
        <div className="container mx-auto px-6 lg:px-20">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Global virtual numbers, instant data & airtime top-ups — all in
              one.
            </h3>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whether it's verifying online, topping up data and airtime, we
              keep everything seamless, secure, and hassle-free.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-green-50 rounded-3xl p-8 relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-6">
                  Receive OTP easily and verify online KYC with our virtual
            ...
            <div className="bg-green-50 rounded-3xl p-8 relative overflow-hidden">
              <div className="relative z-10">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  Buy Data, Airtime and Bill Payment
                </h3>
                <p className="text-gray-600 mb-6">
                  Stay connected online, get your favorite network operator data
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-2">
                      Bypass any text or voice verification with real non-voip
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-2">
                      Give out our numbers instead of yours. Strong encryption
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-2">
                      Build apps using our powerful API. Bulk discount pricing
                      available.
                    </p>
                    <a href="#" className="text-blue-600 underline text-sm">
                      Learn More
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Select from 900+ supported services like WhatsApp, Instagram, or
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Receive a temporary phone number instantly. Use it for
                verification on your chosen service.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Get your verification code instantly and complete your
        ...
        <div className="container mx-auto px-6 lg:px-20">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Trusted worldwide by individuals and businesses who value privacy,
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-700 mb-6">
                "I have been using SMS Pro's renewable rentals for several weeks
                now. It gives me peace of mind when ordering food and
                rideshares."
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-700 mb-6">
                "This is hands down the best tool to bypass 2-factor OTP codes.
                Their numbers always work and the support team is great."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gray-300 rounded-full mr-3"></div>
                <div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-700 mb-6">
                "Got a temporal USA Number on Faddedsms for several weeks now.
                It gives me peace of mind when ordering food and rideshares"
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gray-300 rounded-full mr-3"></div>
                <div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600 mt-4">
                FaddedSMS lets you get real phone numbers to receive SMS or
                voice verifications, sign ups, testing, or protecting your
                personal number.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600 mt-4">
                Yes — all numbers are real, non-VoIP US numbers. They work with
                major services like Google, PayPal, Uber, and more.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-900">
                  How often are numbers restocked?
                </h3>
                <svg
                  className="w-5 h-5 text-gray-500"
                  fill="none"
              ...
              <p className="text-gray-600 mt-4">
                New numbers are added daily. If the one you want isn't
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600 mt-4">
                Your sessions are encrypted, and we accept crypto payments for
                full privacy.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-900">
                  How is this different from Google Voice or VoIP numbers?
                </h3>
                <svg
                  className="w-5 h-5 text-gray-500"
                  fill="none"
              ...
              <p className="text-gray-600 mt-4">
                Unlike VoIP or Google Voice, our real non-VoIP numbers are
                accepted by almost all major platforms, reducing verification
                issues.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 lg:px-20 relative z-10">
          <div className="max-w-2xl">
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 mb-8">
                Reliable International Numbers for SMS and voice
                verifications—secure, instant, and trusted worldwide.
              </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                We are the premier one stop shop for all your SMS, text, and
                voice verification needs. Exceptional service and competitive
                pricing sets us apart from the rest.
              </p>
            </div>

            {/* Links */}
            <div>
              <h3 className="font-semibold text-gray-900 mb-4 uppercase tracking-wider text-sm">
                LINKS
              </h3>
              <ul className="space-y-2 text-gray-600">
                <li>
                  <a
                    href="#"
                    className="hover:text-teal-600 transition-colors text-sm"
                  >
                    Products
                  </a>
                </li>
