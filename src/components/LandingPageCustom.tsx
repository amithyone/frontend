...
import { imageConfig, getImageUrl } from '../config/images';

const LandingPageCustom: React.FC = () => {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Not comfortable sharing your phone number? — <span className="text-yellow-300">Use Ours!</span>
              </h1>
              <p className="text-xl lg:text-2xl text-blue-100 leading-relaxed">
                Receive SMS & OTP from Apps and Websites easily. Works with Google, PayPal, Uber, WhatsApp, Tinder etc.
              </p>
              <button 
                onClick={() => navigate('/register')}
            ...
            {/* Hand holding phone - Right side of hero */}
            <div className="relative flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <div className="hidden w-80 h-96 relative">
        ...
        <div className="container mx-auto px-6 lg:px-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-green-50 rounded-3xl p-8 relative overflow-hidden">
              ...
              <div className="absolute bottom-0 right-0 w-32 h-32 opacity-20">
                <img 
                  src={getImageUrl(imageConfig.featureCards.buyData)} 
                  alt="Wi-Fi Symbol" 
                  className="w-full h-full object-cover"
                  onError={(e) => {
                    const target = e.target as HTMLImageElement;
