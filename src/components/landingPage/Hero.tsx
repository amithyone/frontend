...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative text-white overflow-hidden flex items-center lg:m-5 mt-20 lg:mt-20 rounded-2xl lg:rounded-3xl">
      ...
      {/* Content */}
      <div className="px-6 lg:px-20 pt-16 lg:pt-24 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <h1 className="text-4xl sm:text-5xl xl:text-6xl font-bold leading-tight font-jakarta">
            ...
            <p className="text-lg sm:text-xl text-[#F5FAF9] font-inter">
              Receive SMS & OTP from Apps and Websites easily. Works with
              Google, PayPal, Uber, WhatsApp, Tinder etc.
            </p>
          ...
          >
            <div className="relative flex items-end justify-center">
              <img
                ...
                w-64 sm:w-80 md:w-[400px] lg:w-[520px] xl:w-[780px]
                h-auto relative bottom-0"
              />
              ...
              >
                <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-3">
                  ...
                  <span className="text-gray-800 text-xs sm:text-sm lg:text-sm font-semibold whitespace-nowrap">
                    Virtual Number
                  </span>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute bottom-16 -left-2 sm:bottom-24 sm:-left-4 bg-white rounded-lg sm:rounded-xl lg:rounded-2xl px-2 py-2 sm:px-3 sm:py-2.5 lg:px-4 lg:py-3 shadow-xl lg:shadow-2xl"
              >
                <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-3">
